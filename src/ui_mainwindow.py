...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_timeBaseline = QWidget(self.groupBox_sb_info)
        self.widget_timeBaseline.setObjectName(u"widget_timeBaseline")
        ...
        self.horizontalLayout_timeBaseline.addItem(self.horizontalSpacer_timeBaseline)


        self.verticalLayout_3.addWidget(self.widget_timeBaseline)
        ...
        self.label_cleanup_value = QLabel(self.widget_17)
        self.label_cleanup_value.setObjectName(u"label_cleanup_value")
        self.label_cleanup_value.setMinimumSize(QSize(36, 0))
        self.label_cleanup_value.setAlignment(Qt.AlignRight|Qt.AlignVCenter)

        self.horizontalLayout_15.addWidget(self.label_cleanup_value)
        ...
        self.label_conf_thresh_value = QLabel(self.widget_21)
        self.label_conf_thresh_value.setObjectName(u"label_conf_thresh_value")
        self.label_conf_thresh_value.setMinimumSize(QSize(36, 0))
        self.label_conf_thresh_value.setAlignment(Qt.AlignRight|Qt.AlignVCenter)

        self.horizontalLayout_20.addWidget(self.label_conf_thresh_value)
        ...
        self.label_dilate_value = QLabel(self.widget_13)
        self.label_dilate_value.setObjectName(u"label_dilate_value")
        self.label_dilate_value.setMinimumSize(QSize(24, 0))
        self.label_dilate_value.setAlignment(Qt.AlignRight|Qt.AlignVCenter)

        self.horizontalLayout_13.addWidget(self.label_dilate_value)
        ...
        self.label_vscale_value = QLabel(self.widget_vscale)
        self.label_vscale_value.setObjectName(u"label_vscale_value")
        self.label_vscale_value.setMinimumSize(QSize(24, 0))
        self.label_vscale_value.setAlignment(Qt.AlignRight|Qt.AlignVCenter)

        self.horizontalLayout_11.addWidget(self.label_vscale_value)
        ...
        self.label_skew_value = QLabel(self.widget_skew)
        self.label_skew_value.setObjectName(u"label_skew_value")
        self.label_skew_value.setMinimumSize(QSize(24, 0))
        self.label_skew_value.setAlignment(Qt.AlignRight|Qt.AlignVCenter)

        self.horizontalLayout_12.addWidget(self.label_skew_value)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_cleanup_value.setText(QCoreApplication.translate("MainWindow", u"0%", None))
        ...
        self.label_conf_thresh_value.setText(QCoreApplication.translate("MainWindow", u"50%", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_dilate_value.setText(QCoreApplication.translate("MainWindow", u"1", None))
        ...
        self.label_vscale_value.setText(QCoreApplication.translate("MainWindow", u"10", None))
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"Skew", None))
        self.label_skew_value.setText(QCoreApplication.translate("MainWindow", u"0", None))
#if QT_CONFIG(tooltip)
